...
export class EventsService {
    ...
    async getUserParticipations(userId: number, statuses: EventStatus[] = [EventStatus.OPEN, EventStatus.RUNNING, EventStatus.FINAL, EventStatus.CLOSED]): Promise<Array<Participant & { event: Event }>> {
